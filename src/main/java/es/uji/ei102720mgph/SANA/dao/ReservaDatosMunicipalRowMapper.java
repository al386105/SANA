...
public class ReservaDatosMunicipalRowMapper implements RowMapper<ReservaDatosMunicipal> {
    public ReservaDatosMunicipal mapRow(ResultSet rs, int rowNum) throws SQLException {
        ReservaDatosMunicipal reserva = new ReservaDatosMunicipal();
        ...
        reserva.setName(rs.getString("name"));
        reserva.setSurname(rs.getString("surname"));
        return reserva;
    }
}
